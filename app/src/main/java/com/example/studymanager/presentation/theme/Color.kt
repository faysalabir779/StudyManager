...
val gradient1 = listOf(Color(0xFF00B4DB), Color(0xFF0083B0)) // Deep aqua to blue
val gradient2 = listOf(Color(0xFF00c6ff), Color(0xFF0072ff)) // Your original choice
val gradient3 = listOf(Color(0xFF12c2e9), Color(0xFFc471ed)) // Blue to purple-ish
val gradient4 = listOf(Color(0xFF40E0D0), Color(0xFF0000FF)) // Turquoise to deep blue
val gradient5 = listOf(Color(0xFF0093E9), Color(0xFF80D0C7)) // Light blue to teal